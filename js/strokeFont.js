...
const GLYPHS = {
    ...
    '@': {
        width: 0.7,
        path: [
            // inner bowl (counter-clockwise), then down the right side
            [0.48, 0.52], [0.44, 0.57], [0.36, 0.59], [0.27, 0.55],
            [0.23, 0.46], [0.27, 0.37], [0.36, 0.33], [0.44, 0.36],
            [0.48, 0.44], [0.49, 0.35],
            // tail sweeps out and around the outer ring, opening bottom-right
            [0.55, 0.31], [0.63, 0.33], [0.68, 0.46],
            [0.58, 0.69], [0.35, 0.79], [0.12, 0.69], [0.02, 0.46],
            [0.12, 0.23], [0.35, 0.13], [0.52, 0.18]
        ]
    }
};
